...
from uk_post_codes.post_code import validate_post_code_regex


class UkPostCodesRegexTestCaseCommonCases(unittest.TestCase):
...
class UkPostCodesRegexTestCaseAnguilla(unittest.TestCase):
...
class UkPostCodesRegexTestCaseAscensionIsland(unittest.TestCase):
...
class UkPostCodesRegexTestCaseBritishIndianOceanTerritory(unittest.TestCase):
...
class UkPostCodesRegexTestCaseAkrotiriAndDhekelia(unittest.TestCase):
...
class UkPostCodesRegexTestCaseBritishAntarcticTerritory(unittest.TestCase):
...
class UkPostCodesRegexTestCaseFalklandIslands(unittest.TestCase):
...
class UkPostCodesRegexTestCaseMontserrat(unittest.TestCase):
...
class UkPostCodesRegexTestCaseCaymanIslands(unittest.TestCase):
...
class UkPostCodesRegexTestCasePitcairnIslands(unittest.TestCase):
...
class UkPostCodesRegexTestCaseSouthGeorgiaSouthSandwichIslands(unittest.TestCase):
...
class UkPostCodesRegexTestCaseSaintHelena(unittest.TestCase):
...
class UkPostCodesRegexTestCaseTristanCunha(unittest.TestCase):
...
class UkPostCodesRegexTestCaseTurksCaicosIslands(unittest.TestCase):
...
class UkPostCodesRegexTestCaseTortolaCentral(unittest.TestCase):
...
class UkPostCodesRegexTestCaseTortolaEast(unittest.TestCase):
...
class UkPostCodesRegexTestCaseTortolaWest(unittest.TestCase):
...
class UkPostCodesRegexTestCaseAnegada(unittest.TestCase):
...
class UkPostCodesRegexTestCaseVirginGorda(unittest.TestCase):
...
class UkPostCodesRegexTestCaseJostVanDyke(unittest.TestCase):
